...
export function BenefitsStrip({ tr }: { tr: any }) {
  ...
  return (
    <>
      <div className="mx-auto grid grid-cols-2 border border-[#e1e7ef] rounded-[9px] shadow-[0_18px_45px_rgba(31,41,55,0.08)] overflow-hidden md:grid-cols-3 lg:grid-cols-6">
        {benefits.map((item, i) => {
